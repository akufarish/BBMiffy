  ...
  return (
    <div className="w-[415px] cursor-pointer group h-[225px] bg-bg p-6 relative rounded-md flex flex-col gap-4">
      ...
      <div
        ...
        className="absolute w-12 h-12 opacity-0  bg-green-500 rounded-full bottom-8 right-8 flex justify-center group-hover:opacity-100 items-center duration-500 transition-all hover:bg-green-400"
      >
